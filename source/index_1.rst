...
I am a **PhD researcher and machine learning engineer** specializing in **industrial AI** and **reinforcement learning**. My work bridges the gap between cutting-edge research and real-world applications, with a focus on optimizing complex industrial control systems using advanced deep learning techniques.

**Current Research:** Developing end-to-end reinforcement learning solutions for resource allocation in high-throughput industrial systems, featuring novel curriculum learning strategies and hybrid RL-planning architectures.
...
My research program focuses on **bridging the theory-practice gap** in machine learning by developing robust, scalable solutions for complex industrial control problems. I specialize in advanced reinforcement learning techniques—particularly curriculum learning and hybrid RL-planning architectures—to optimize resource allocation in real-world, high-throughput systems with stochastic dynamics and strict safety constraints.

**Research Impact:** 4 peer-reviewed publications, 1 open-source benchmark adopted by the community, novel algorithms achieving significant performance improvements in industrial settings.
...
.. raw:: html
    ...
    <div style="text-align: center; font-size: 1.1em; margin: 20px 0;">
        <p>
            📧 <a href="mailto:abhijeet.pendyala@gmail.com" target="_blank" style="text-decoration: none; color: #007acc;"> 
            abhijeet.pendyala@gmail.com
            </a>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            💼 <a href="https://www.linkedin.com/in/abhijeet-pendyala-3ba00942/" target="_blank" style="text-decoration: none; color: #007acc;"> 
            LinkedIn
            </a>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            🔬 <a href="https://github.com/Pendu" target="_blank" style="text-decoration: none; color: #007acc;"> 
            GitHub
            </a>
            &nbsp;&nbsp;|&nbsp;&nbsp;
            📚 <a href="https://www.researchgate.net/profile/Abhijeet_Pendyala" target="_blank" style="text-decoration: none; color: #007acc;"> 
            ResearchGate
            </a>
        </p>
    </div>
